...
class ObjectHandler:
    ...
    #     if (self.game.player.x, self.game.player.y) <= pos:
    #         addSprites(AnimatedSprites(game, path=self.animatedSpritePath + 'red_light/0.png', pos=pos))
    #     elif (self.game.player.x, self.game.player.y) > pos:
    #         addSprites(AnimatedSprites(game, pos=pos))
